              ...
              <tr>
                ...
                <td>
                  <div class="d-flex justify-content-around align-items-center">
                    <a href="editar.php?id=<?php echo $fila['id'] ?>" class="text-success"><i class="bi bi-pencil-square"></i></a> <a href="eliminar.php?id=<?php echo $fila['id'] ?>" class="text-danger" onclick="return confirm('Estas seguro de eliminar?');"><i class="bi bi-trash"></i></a>
                  </div>
                </td>
